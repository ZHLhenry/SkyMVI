 ...
 */
@Composable
fun <S : UiState, I : UiIntent, E : UiEffect> LaunchedIntent(
 ...
 *
 * ```
 * val dispatch = rememberIntentDispatcher(viewModel)
 * HomeContent(state = state, onIntent = dispatch)
 * ```
 */
@Composable
fun <S : UiState, I : UiIntent, E : UiEffect> rememberIntentDispatcher(
    viewModel: BaseMviViewModel<S, I, E>
): (I) -> Unit {
