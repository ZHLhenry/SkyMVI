...
import com.sky.mvi.ext.view.clickNoRepeat
 ...
 * 复制文本到粘贴板
 */
fun Context.copyToClipboard(text: String, label: String = "SkyMVI") {
 ...
 * @param onClick 点击触发的方法
 */
fun setDebouncedClickListener(vararg views: View?, interval: Long = 500, onClick: (View) -> Unit) {
    views.forEach {
